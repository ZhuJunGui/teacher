...
public class ResultController {
    ...
    @ResponseBody
    public Object addResult(@RequestParam Integer resultNo, @RequestParam Integer subjectNo, @RequestParam String examDate, @RequestParam Integer studentResult) throws ParseException {
        Result result = new Result();
        result.setResultNo(resultNo);
